  ...
  const handleChange = (e) => {
    ...
    if (name === 'isWhatsappSame') {
      setFormData({
        ...formData,
        [name]: checked,
        whatsapp: checked ? formData.phone : '', // Clear whatsapp when unchecked
      });
    } else {
      setFormData({
        ...formData,
        ...
        <div className="w-full px-8">
          ...
          <div className="mb-6">
            ...
            {formData.taxExemption === 'Yes' && (
              <p className="text-red-600 mt-2 text-sm">
                Note - If Yes, Company UIN and PAN Number are mandatory
              </p>
            )}
          </div>
          <div className="mb-6">
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              className="w-1/5 p-3 text-lg bg-blue-900 text-white rounded

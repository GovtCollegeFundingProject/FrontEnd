...
const Footer = () => {
  return (
    <div>
    <div
  className="h-80 w-full flex items-start justify-between"
  style={{
...
>
  <div className="flex flex-col items-start justify-start space-x-5 p-5">
    <div className="flex space-x-5">
      <img src="./img1.jpeg" alt="logo" className="h-20 w-20" />
      <img src="./AAhublogo.png" alt="logo" className="h-20 w-20" />
      <img src="./statecouncil.png" alt="logo" className="h-20 w-20" />
    </div>
  ...
  <div className="flex items-start justify-end space-x-16 p-5 w-1/2">

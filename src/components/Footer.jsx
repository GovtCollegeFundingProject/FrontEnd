...
//     <div>
//       <div
//         className="h-auto w-full flex flex-col md:flex-row items-start justify-between p-5"
//         style={{
//           background:
//             "linear-gradient(97.37deg, rgba(253, 155, 71, 0.9) 0.43%, rgba(255, 255, 255, 0.9) 36.6%, rgba(255, 255, 255, 0.9) 61%, rgba(7, 159, 1, 0.9) 100%)",
//         }}
//       >
//         <div className="flex flex-col items-start justify-start space-y-5 md:space-y-0 md:space-x-5 p-5 w-full md:w-1/3">
//           <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-5 pl-0 md:pl-5">
//             <img
//               src={img}
//               alt="logo"
//               className="h-16 w-16 md:h-20 md:w-20 mix-blend-multiply"
//             />
//             <img
//               src={img2}
//               alt="logo"
...
//             />
//           </div>
//           <p className="text-center md:text-left font-bold mt-5 md:mt-10 text-lg md:text-xl text-gray-800 w-full md:w-96">
//             Join the Government of AP in building world-class labs for Junior
//             Colleges.
//           </p>
//         </div>
//         <div className="flex flex-col md:flex-row items-start justify-center p-5 w-full md:w-2/3 space-y-5 md:space-y-0">
...
//           </div>
//           <div className="w-full md:w-1/2">
//             <h3 className="font-bold text-xl md:text-2xl mb-3">Active Links</h3>
//             <ul className="space-y-3 md:space-y-5">
//               <li>
//                 <a
...
//           </div>
//           <p
//             className="text-center md:text-left font-bold mt-5 md:mt-10 text-lg md:text-xl text-gray-800 w-full md:w-96"
//             style={{
//               marginBottom: "20px", // Add bottom margin to prevent overlap
//               maxWidth: "100%", // Ensure text doesn't exceed the container width
//             }}
//           >
//             Join the Government of AP in building world-class labs for Junior
//             Colleges.
...
const Footer = () => {
  return (
    <div>
      <div
        className="h-auto w-full flex flex-col md:flex-row flex-wrap items-start justify-between p-5"
        style={{
          background:
            "linear-gradient(97.37deg, rgba(253, 155, 71, 0.9) 0.43%, rgba(255, 255, 255, 0.9) 36.6%, rgba(255, 255, 255, 0.9) 61%, rgba(7, 159, 1, 0.9) 100%)",
        }}
      >
        {/* Logos Section */}
        <div className="flex flex-col items-start justify-start space-y-5 md:space-y-0 md:space-x-5 p-5 w-full md:w-1/3">
          <div className="flex flex-wrap md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-5 pl-0 md:pl-5">
            <img
              src={img}
              alt="logo"
              className="h-16 w-16 md:h-20 md:w-20 mix-blend-multiply"

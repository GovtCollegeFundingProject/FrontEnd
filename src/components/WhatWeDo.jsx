...
const WhatWeDo = () => {
  ...
  return (
    <div id="contributors" className="w-full mb-8 px-4">
      <h2 className="text-center text-[#06038D] font-semibold text-2xl md:text-3xl mb-8">
        What we do.
      </h2>
      <div className="flex flex-col md:flex-row justify-center md:space-x-12 mt-8 md:mt-14 space-y-8 md:space-y-0">
        {/* General Specific */}
        <div className="border-4 border-[#06038D] p-6 rounded-md w-full md:w-1/4">
          <img src={imga} alt="General Specific" className="mx-auto mb-4" />
          <h3 className="text-center text-lg md:text-xl font-semibold mb-2">
            General Specific
          </h3>
          <p className="text-center text-md md:text-lg mb-4">
            Contribute to the Development of Infrastructure in Junior Colleges
            of Andhra Pradesh
          </p>
          <div className="flex justify-center">
            <button
              className="bg-[#06038D] text-white font-semibold py-2 px-4 rounded"
              onClick={handleClick1}
            >
              Contribute <NearMe className=" text-white text-sm ml-1.5" />
            </button>
          </div>
        </div>
        ...
        <div className="border-4 border-[#06038D] p-6 rounded-md w-full md:w-1/4">
          ...
          <p className="text-center text-md md:text-lg mb-4">
            Contribute to the Development of Infrastructure in a specific Junior
            College of Andhra Pradesh
          </p>
          <div className="flex justify-center">
            <button
              className="bg-[#06038D] text-white font-semibold py-2 px-4 rounded"

    ...
    <div className="w-full mb-8">
      ...
      <div className="flex justify-center space-x-48 mt-14">
        <div className="border-4 border-[#06038D] p-6 rounded-md w-1/4">
          <img src={`https://via.placeholder.com/100`} alt="General Specific" className="mx-auto mb-4" />
        ...
        <div className="border-4 border-[#06038D] p-6 rounded-md w-1/4">
          <img src={`https://via.placeholder.com/100`} alt="College Specific" className="mx-auto mb-4" />
